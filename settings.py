...
# editor
editor_caption = "Tanks | Редактор рівнів"
BUTTON_BG_COLOR = '#33323d'
BUTTON_LINE_COLOR = '#f5f1de'
editor_info = '''За допомогою редактора карт можна створювати власні рівні та проходити їх!\n
Інструкція.\n
Щоб додавати елементи:
Клавіша 1 — створення звичайного блоку, який можна зруйнувати
Клавіша 2 — створення міцного блоку, який неможливо зруйнувати
Клавіша 3 — створення звичайного танка-гравця
Клавіша 4 — створення танка-бота\n
Також можна використовувати меню.\n
Щоб зміщувати карту:
- натискайте клавіші a, s, d, w або стрілочки
- прокучуйте коліщатко миші (з затиснутою клавішею shift і без)
- рухайте мишею з затиснутим коліщатком\n
'''
